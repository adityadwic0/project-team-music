    ...
    <head>
        ...
        <style>
            ...
            @keyframes pulse-danger {
                0%, 100% { box-shadow: 0 0 15px rgba(239, 68, 68, 0.2); border-color: rgba(239, 68, 68, 0.3); }
            ...
            .btn-outline { background: rgba(255, 255, 255, 0.05); color: #9ca3af; border: 1px solid rgba(255, 255, 255, 0.1); }
            ...
            .grid-choices {
                display: grid;
                grid-template-columns: 1fr 1fr 1fr; /* Ubah ke 3 kolom */
                gap: 1rem;
                margin-top: 3rem;
            }
            ...
            h1 { font-size: 3.5rem; font-weight: 800; letter-spacing: -0.04em; margin: 0; line-height: 1; }
            p.subtitle { color: #6b7280; font-size: 1.1rem; margin-top: 1rem; }
        </style>
    </head>
        ...
        <main>
            <div class="glass-card">
                ...
                <footer style="margin-top: 3rem; font-size: 0.7rem; color: #4b5563; letter-spacing: 0.1em;">
                    WARNING: STRESS TEST MODE WILL CONSUME HIGH CPU & RAM
                </footer>
            </div>
        </main>
